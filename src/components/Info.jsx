...
//     // Keep this as is if you want the overall content to also use auto-fill for larger items like charts
//     // If you want charts to always span full width or fixed columns, adjust accordingly.
...
//           {" "}
//           {/* Ensure error message spans full width */}
//           त्रुटि: {error}
//         </p>
//       )}
...
//             </div>
//             {/* THIS IS THE KEY CHANGE: Use auto-fit for these smaller cards */}
//             <div className="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-6 col-span-full">
//               {/* Card for the single value metric (e.g., ID 1000000) */}
//               {singleValueMetric && (
//                 <Card title={singleValueMetric.name} loading={false}>
...
//                   {/* Reduced vertical padding (py-4 to py-2) to allow content to fit better */}
...
//                 title={lineChartMetric.name || "चार्ट डेटा"}
//                 loading={false}
//                 // Removed className="col-span-2" from here.
//                 // The main grid's auto-fill will handle its width.
//                 // If you specifically want it to span 2 columns on larger screens,
//                 // you would need a different strategy (e.g., another nested grid or media queries).
//                 enableDownloads={true}
//                 onDownloadSVG={handleDownloadSVG}
//                 onDownloadCSV={handleDownloadCSV}
//                 onDownloadPNG={handleDownloadPNG}
...
//             {" "}
//             {/* Ensure fallback message spans full width */}
//             डाटा उपलब्ध छैन।
//           </p>
//         )}
//     </div>
