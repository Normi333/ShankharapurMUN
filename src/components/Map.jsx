...
//   GeoJSON,
//   LayersControl,
//   LayerGroup, // Keep if you plan to use LayerGroup for other purposes
// } from "react-leaflet";
...
//     if (roadType === "Internal") {
//       return {
//         weight: 3, // Slightly thicker for internal
//         color: "purple", // Distinct color for internal roads
//       };
//     } else if (roadType === "External") {
//       return {
//         weight: 2,
//         color: "orange", // Original color for external roads
//       };
//     }
//     // Default style if type is neither Internal nor External, or undefined
//     return {
//       weight: 1.5,
//       color: "gray",
//       dashArray: "5, 5", // Maybe a dashed line for unknown types
//     };
//   };
...
//         color: "red",
//       };
//     } else if (BuildingType === "Government-Agro Office") {
//       return {
//         weight: 1.5,
//         color: "blue",
//       };
...
//     const { FID, Id, type } = feature.properties;
//     layer.bindPopup(`
//       <b>FID:</b> ${FID}<br/>
//       <b>Id:</b> ${Id}<br/>
...
//           {/* OpenStreetMap - Set checked to true */}
...
//           {/* Google Satellite - Remove checked prop or set it to false */}
//           <LayersControl.BaseLayer name="Google Satellite">
//             {" "}
//             {/* Removed 'checked' prop */}
//             <TileLayer
...
//           <GeoJSON
//             data={roadData}
//             style={roadStyle} // Now calls the function for each feature
