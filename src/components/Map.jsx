...
function Map({ selectedLayers }) {
  ...
  // Modified BuildingStyle to prioritize specific types
  const BuildingStyle = (feature) => {
    const BuildingType = feature.properties.Type;
  ...
  const filterBuildings = (feature) => {
    ...
    // If any specific building type is selected, or if residential is specifically selected,
    // ensure that residential buildings are always included.
