...
//   // From /models/lg_hsurvey_income_source
//   Name: "/models/lg_hsurvey_income_source", // This 'Name' should be specific to income sources or renamed if ambiguous
...
//   Name: "रोजगारीको स्रोतको नाम", // For income/expense/saving/loan/service sources - adjust if 'Name' is generic
...
//   const pieOptions = {
//     chart: { type: "pie" },
//     title: { text: nepalParamName }, // ** UPDATED: Use Nepali name for title **
//     series: [
//       {
//         name: "जनसंख्या",
//         data: tableData.map((d) => ({ name: d.label, y: d.value })),
...
//         const dataForTable = Object.entries(group).map(([label, value]) => ({
//           label: NEPAL_COLUMN_NAMES[label] || label, // ** UPDATED: Map label to Nepali if it's a known value like 'अन्य' **
//           value,
//         }));
...
export const COLUMN_TO_API_POSTFIX_MAP = {
  ...
  // "service-source-name": {
  //   api: "/models/lg_hsurvey_service_source",
  //   column: "Name",
  // },
