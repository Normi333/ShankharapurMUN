...
function Sidebar({
  ...
  // Determine if the dynamic columns section should be hidden
  const shouldHideDynamicColumns =
    pathname.startsWith(surveyData.householdReports.prefix) ||
    pathname.startsWith(surveyData.institutionalReports.prefix);
      ...
      >
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            {/* Dynamic report columns section - Conditional rendering added here */}
            {!shouldHideDynamicColumns && (
              <div className="mt-8 pt-8 border-t border-white/[0.2]">
                <h3 className="text-xs uppercase text-gray-300 font-semibold pl-3 mb-3">
                  रिपोर्टका लागि स्तम्भहरू
                </h3>
